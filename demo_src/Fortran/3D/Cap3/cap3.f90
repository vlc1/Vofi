...
REAL(8) FUNCTION IMPL_FUNC(userdata, xyz)
  ...
  REAL(8), PARAMETER ::  XC = 0.35D0, YC = 0.35D0, ZC = -5.97D0
...
SUBROUTINE CHECK_VOLUME(volnum)
  ...
  write(*,*) 'numerical  volume:  9.4090697360378721E-03'
  write(*,*) ' '
  write(*,*) 'absolute error   :  2.6146371352731013E-10'
  write(*,*) 'relative error   :  2.7788475757618687E-08'
  write(*,*) '---------------- F: end cap check (3 cells) ---------------'
  write(*,*) '-----------------------------------------------------------'
  write(*,*) ' '
